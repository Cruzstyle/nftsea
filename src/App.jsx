    ...
    <Layout style={{ height: "100vh", overflow: "auto", overflowX:"auto"}}>
      <Router>
        ...
        <Header style={styles.header}>
          <MediaQuery minWidth={155} onChange={handleMediaQueryChange}><Logo/></MediaQuery>
          <MediaQuery maxWidth={155} onChange={handleMediaQueryChange}> <Log/></MediaQuery>
          
           <MediaQuery minWidth={155} onChange={handleMediaQueryChange}> <SearchCollections setInputValue={setInputValue} /></MediaQuery>
           <MediaQuery maxWidth={155} onChange={handleMediaQueryChange}><SearchCollection setInputValue={setInputValue}/></MediaQuery>


          <MediaQuery maxWidth={155} onChange={handleMediaQueryChange}><Menu
              theme="light"
              mode="horizontal"
              style={{
                display: "flex",
...
<MediaQuery minWidth={155} onChange={handleMediaQueryChange}>
          <Menu
            theme="light"
            mode="horizontal"
            style={{
     ...
     <div style={{ textAlign: "center", fontWeight: "Bold", marginTop: "35px", fontSize:"23px"}}>  <MediaQuery minWidth={155} onChange={handleMediaQueryChange}> <Latest/></MediaQuery></div>
          <div style={{ marginLeft:"10px", textAlign: "center", fontWeight: "Bold", marginTop: "15px", fontSize:"9.5px"}}>  <MediaQuery maxWidth={155} onChange={handleMediaQueryChange}> <Latest/></MediaQuery></div>
...
<MediaQuery maxWidth={155} onChange={handleMediaQueryChange}>
      <Footer style={{ textAlign: "center" }}>
